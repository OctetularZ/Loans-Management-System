...
public class Mortgage extends Loan { // Inherits the Loan class
    // Default constructor
    private String overpayment;
    public Mortgage() {
        this.recordID = "000000";
        this.typeOfLoan = "Mortgage";
    ...
    public Mortgage(String recordID, String interestRate, String amountToPay, String loanTermLeft, String overpayment) {
